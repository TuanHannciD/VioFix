...
namespace AppAPI.Services
{
    public class KhuyenMaiServices : IKhuyenMaiServices
    {
        ...
        private readonly IAllRepository<PhongCach> _reposPC;
        private readonly IAllRepository<DungTich> _reposSize;
        ...
        public KhuyenMaiServices()
        {
            ...
            _reposPC = new AllRepository<PhongCach>(context, context.PhongCachs);
        }
