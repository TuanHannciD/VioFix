    ...
    public partial class Update_All : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DungTich", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDNhomHuong = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SanPham_NhomHuong_IDNhomHuong",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<int>(type: "int", nullable: false),
                    IDPhongCach = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Anh_PhongCach_IDPhongCach",
                        column: x => x.IDPhongCach,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDPhongCach = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IDDungTich = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_ChiTietSanPham_PhongCach_IDPhongCach",
                        column: x => x.IDPhongCach,
                        principalTable: "PhongCach",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "KhachHang",
                columns: new[] { "IDKhachHang", "DiaChi", "DiemTich", "Email", "GioiTinh", "NgaySinh", "Password", "SDT", "Ten", "TrangThai" },
                values: new object[] { new Guid("2ec27ab7-5f67-4ed5-ae67-52f9c9726ebf"), "Thanh Hoa", 1, "doba2311@gmail.com", 0, null, "$2a$10$gvO967pZ88UeyW693ps38.FTkSii9XrNtTI1vLoONujRx.uKjJOEq", "0773332975", "Admin", 0 });
            ...
            migrationBuilder.InsertData(
                table: "GioHang",
                columns: new[] { "IDKhachHang", "NgayTao" },
                values: new object[] { new Guid("2ec27ab7-5f67-4ed5-ae67-52f9c9726ebf"), new DateTime(2024, 12, 31, 12, 5, 27, 811, DateTimeKind.Local).AddTicks(5710) });

            migrationBuilder.InsertData(
                table: "NhanVien",
                columns: new[] { "ID", "DiaChi", "Email", "IDVaiTro", "PassWord", "SDT", "Ten", "TrangThai" },
                values: new object[] { new Guid("2ec27ab7-5f67-4ed5-ae67-52f9c9726ebf"), "Ha Noi", "doba2311@gmail.com", new Guid("b4996b2d-a343-434b-bfe9-09f8efbb3852"), "$2a$10$gvO967pZ88UeyW693ps38.FTkSii9XrNtTI1vLoONujRx.uKjJOEq", "0773332975", "Admin", 1 });

            migrationBuilder.CreateIndex(
                name: "IX_Anh_IDPhongCach",
                table: "Anh",
                column: "IDPhongCach");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChiTietSanPham_IDPhongCach",
                table: "ChiTietSanPham",
                column: "IDPhongCach");
