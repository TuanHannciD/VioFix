...
namespace AppView.Controllers
{
    public class DungTichController : Controller
    {
        ...
        public async Task<IActionResult> Create(DungTich ms)
        {
            try
            {
                ms.TrangThai = 1;
                ...
                string apiUrl = $"https://localhost:7095/api/DungTich/ThemDungTich?ten={ms.Ten}&ma={ms.Ma}&trangthai={ms.TrangThai}";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, DungTich ms)
        {
            ...
            try
            {
                ...
                {
                    string encodedDungTich = Uri.EscapeDataString(ms.Ma);
                    string apiUrl = $"https://localhost:7095/api/DungTich/{id}?ten={ms.Ten}&ma={encodedDungTich}&trangthai={ms.TrangThai}";
