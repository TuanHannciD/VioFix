    ...
    public class ThongKeViewController : ControllerBase
    {
        ...
        public List<ThongKeMSSanPhamTheoSoLuong> ThongKeSanPhamMuaSapXep()
        {
            var result = _dbContext.ChiTietHoaDons
                ...
                .Join(_dbContext.DungTichs, cthd_cts_sp => cthd_cts_sp.ChiTietHoaDon_ChiTietSanPham.ChiTietSanPham.IDDungTich, ms => ms.ID, (cthd_cts_sp, ms) => new { ChiTietHoaDon_ChiTietSanPham_SanPham = cthd_cts_sp, DungTich = ms })
                .Join(_dbContext.HoaDons, cthd_cts_sp_ms => cthd_cts_sp_ms.ChiTietHoaDon_ChiTietSanPham_SanPham.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.IDHoaDon, hd => hd.ID, (cthd_cts_sp_ms, hd) => new { ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich = cthd_cts_sp_ms, HoaDon = hd })
               
                .GroupBy(cthd_cts_sp_ms_hd => cthd_cts_sp_ms_hd.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.SanPham.ID)
                .Select(group => new ThongKeMSSanPhamTheoSoLuong
                {
                    idSanPham = group.FirstOrDefault().ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.SanPham.ID,
                    TenSP = group.FirstOrDefault().ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.SanPham.Ten.Trim().ToString(),
                    
                    SoLuong = group.Sum(cthd_cts_sp_ms_hd => cthd_cts_sp_ms_hd.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.SoLuong),
                    Gia= group.FirstOrDefault().ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.ChiTietHoaDon_ChiTietSanPham.ChiTietSanPham.GiaBan,
                    DoanhThu= group.Sum(cthd_cts_sp_ms_hd => cthd_cts_sp_ms_hd.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.SoLuong) * group.FirstOrDefault().ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham_SanPham.ChiTietHoaDon_ChiTietSanPham.ChiTietSanPham.GiaBan,
        ...
        public List<ThongKeDoanhThu> ThongKeDoanhThuTheoThang()
        {
            var result = _dbContext.ChiTietHoaDons
                ...
                .Join(_dbContext.HoaDons, cthd_cts_sp_ms => cthd_cts_sp_ms.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.IDHoaDon, hd => hd.ID, (cthd_cts_sp_ms, hd) => new { ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich = cthd_cts_sp_ms, HoaDon = hd }).
                ...
                .Select(group => new ThongKeDoanhThu
                {
                    ...
                    //DoanhThu = group.Sum(x => x.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.DonGia * x.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.SoLuong + x.HoaDon.TienShip-x.HoaDon.ThueVAT.Value),
                    DoanhThu = group.Sum(x => x.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.DonGia * x.ChiTietHoaDon_ChiTietSanPham_SanPham_DungTich.ChiTietHoaDon_ChiTietSanPham.ChiTietHoaDon.SoLuong + x.HoaDon.TienShip),
                    Ngay = group.FirstOrDefault().HoaDon.NgayThanhToan.Value
                })
