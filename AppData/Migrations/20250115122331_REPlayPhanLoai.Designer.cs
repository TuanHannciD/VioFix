...
namespace AppData.Migrations
{
    ...
    [Migration("20250115122331_REPlayPhanLoai")]
    partial class REPlayPhanLoai
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppData.Models.LuuHuong", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LuuHuong", (string)null);
                });
            ...
            modelBuilder.Entity("AppData.Models.PhanLoai", b =>
                {
                    b.Property<Guid?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppData.Models.Anh", b =>
                {
                    b.HasOne("AppData.Models.PhanLoai", "PhanLoai")
                        .WithMany("Anhs")
            ...
            modelBuilder.Entity("AppData.Models.SanPham", b =>
                {
                    ...
                    b.HasOne("AppData.Models.LuuHuong", "LuuHuong")
                        .WithMany("SanPhams")
                        .HasForeignKey("IDLuuHuong")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoaiSP");

                    b.Navigation("LuuHuong");
                });
